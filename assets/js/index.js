window.addEventListener('DOMContentLoaded', () => {
  let e = document.querySelector('.burger'),
    ...
    i = document.querySelector('.header__menu')
  e.addEventListener('click', () => {
    e.classList.toggle('header__menu_active'),
      i.classList.toggle('header__menu_active'),
      t.classList.toggle('header__menu_active')
  })
  let a = localStorage.getItem('lang') ? localStorage.getItem('lang') : 'ru',
    s
  function o() {
    s = [
      [
        ...
        {
          id: 2,
          name: 'ru' === a ? 'Журавль' : 'Crane',
          species: 'Grus grus',
          description:
            'ru' === a
              ? 'Звуки, издаваемые журавлем, похожи на звонкое \xabкур-лы – кур-лы\xbb. Журавли чаще всего поют дуэтом – одна птица начинает запев со слога \xabкур\xbb, а вторая подхватывает \xabлы\xbb. Если птица поёт одна, то она издает только звук \xabкур\xbb.'
        ...
        {
          id: 3,
          name: 'ru' === a ? 'Ласточка' : 'Martin',
          species: 'Delichon urbicum',
          description:
            'ru' === a
              ? 'Для ласточек характерно негромкое щебетание. Песни ласточек не смолкают на протяжении всего лета. Исследователи различают у птиц до 6 щебечущих звуков: \xabвит\xbb, \xabви-вит\xbb, \xabчивит\xbb, \xabчиривит\xbb и т.п. Ласточки любят петь дуэтом.'
        ...
        {
          id: 5,
          name: 'ru' === a ? 'Кукушка' : 'Cuckoo',
          species: 'Cuculus canorus',
          description:
            'ru' === a
              ? 'Кукушку назвали так из-за особенностей ее песен. Звонкое \xabку-ку\xbb не спутать ни с какой другой птицей. Кукушки не строят гнезда, их потомство выращивают другие виды пернатых, которым кукушки подбрасывают свои яйца.'
      ...
      [
        ...
        },
        {
          ...
          description:
            'ru' === a
              ? 'Грачи очень умные и сообразительные птицы. С помощью клюва они создают и используют простейшие орудия. У грачей развит рефлекс на звуки трактора. Услышав \xabтарахтение\xbb, они летят на звук – трактор пашет землю, значит, в этом месте много корма.'
        ...
        {
          id: 3,
          name: 'ru' === a ? 'Галка' : 'Jackdaw',
          species: 'Coloeus monedula',
          description:
            'ru' === a
              ? 'Слово \xabгалка\xbb произошло из старославянского языка и переводится как \xabчёрный\xbb. Этим словом часто называют воронов или других черных птиц. Латинское название галки \xabmonedula\xbb связывают со словами монета за любовь птицы к блестящим и ярким вещам.'
        ...
        {
          id: 4,
          name: 'ru' === a ? 'Певчий дрозд' : 'Song thrush',
      ...
      [
        ...
        {
          id: 2,
          name: 'ru' === a ? 'Клёст' : 'Crossbill',
          species: 'Loxia curvirostra',
          description:
            'ru' === a
              ? 'Клестов называют \xabрождественскими\xbb птицами. В естественных условиях они дают потомство зимой – в январе. Эти птицы утепляют свои гнезда мхом и шерстью животных, потому птенцам не холодно. В поисках шишек клесты могут улетать за 3500 км от гнезда.'
        ...
        {
          id: 4,
          name: 'ru' === a ? 'Дятел' : 'Woodpecker',
          species: 'Dendrocopos major',
          description:
            'ru' === a
              ? 'Дятел – заметная и шумная птица, часто живет рядом с человеком. С середины января до конца июня можно услышать \xabбарабанную дробь\xbb дятлов – трель от вибрации веток под быстрыми ударами клюва птицы. В хорошую погоду дробь слышна в радиусе 1,5 км.'
      ...
      [
        ...
        },
        {
          ...
          description:
            'ru' === a
              ? 'Лунь – это небольшой сокол. Питается в основном мышевидными грызунами, основа его рациона – полёвки, хомяки, мыши. Оперение луня может быть пепельно-серым. С такой птицей связано сравнение \xabседой, как лунь\xbb.'
        ...
        {
          id: 4,
          name: 'ru' === a ? 'Сокол' : 'Falcon',
          species: 'Falco peregrinus',
          description:
            'ru' === a
              ? 'Латинское название сокола Falco произошло от слова \xabсерп\xbb из-за серповидной формы крыльев. Длинные и широкие крылья позволяют соколу высоко подниматься в небо и свободно парить. Скорость полёта сокола достигает 280-320 километров в час.'
        ...
        {
          id: 5,
          name: 'ru' === a ? 'Ястреб' : 'Hawk',
          species: 'Accipiter gentilis',
          description:
            'ru' === a
              ? 'Для всех ястребов характерны широкие и короткие крылья. Ещё один отличительный признак - белые \xabброви\xbb над глазами. Славянские дружинники размещали изображение ястреба на своих знаменах, как символ отваги, мощи и безжалостности к врагам.'
  ...
  o()
  let r = document.querySelector('.header__lang-russian'),
    n = document.querySelector('.header__lang-english'),
    l = document.querySelectorAll('.header__menu-link'),
    c = document.querySelector('.footer__text'),
    d = document.querySelectorAll('.game__pagination-item'),
    u = document.querySelector('.game__score'),
    h
  function p() {
    let e = document.querySelectorAll('.gallery__item-texts'),
      t = 0
    e.forEach((e) => {
      e.innerHTML = ''
    }),
      s.forEach((i) => {
        i.forEach((i) => {
          ;(e[t].innerHTML = `
              <h3 class="gallery__item-title">${i.name}</h3>
              <p class="gallery__item-kind">${i.species}</p>
              <p class="gallery__item-text">${i.description}</p>
            `),
            (t = ++t)
        })
      })
  ...
  function m() {
    let e = document.querySelector('.result__title'),
      t = document.querySelector('.result__text-part-1'),
      i = document.querySelector('.result__text-part-2'),
      s = document.querySelector('.result__btn a')
    ;(e.textContent = 'ru' === a ? 'Поздравляем!' : 'Congratulations!'),
      (t.textContent =
        'ru' === a
          ? 'Вы прошли викторину и набрали'
          : 'You passed the quiz and scored'),
      (i.textContent =
        'ru' === a ? 'из 30 возможных баллов.' : 'out of 30 possible points.'),
      (s.textContent = 'ru' === a ? 'Попробовать ещё раз' : 'Try again')
  }
  function g() {
    if (
      (l.forEach((e, t) => {
        switch (t) {
          case 0:
            e.textContent = 'ru' === a ? 'Главная' : 'Home'
            break
          case 1:
            e.textContent = 'ru' === a ? 'Игра' : 'Game'
            break
          case 2:
            e.textContent = 'ru' === a ? 'Галерея' : 'Gallery'
        }
      }),
      (c.innerHTML =
        'ru' === a
          ? `<p class="footer__text">
        \xa9 2022 Мирзабек уулу К.
        <a
          class="footer__link"
          target="_blank"
      ...
      let e = document.querySelector('.intro__title'),
        t = document.querySelector('.intro__text'),
        i = document.querySelectorAll('.intro__list-item'),
        s = document.querySelector('.intro__btn a')
      ;(e.textContent = 'ru' === a ? 'Игра Songbird' : 'Songbird Game'),
        (t.textContent = 'ru' === a ? 'Правила игры: ' : 'Game Rules: '),
        i.forEach((e, t) => {
          switch (t) {
            case 0:
              e.textContent =
                'ru' === a ? '1. Прослушиваете звук' : '1. Listen to the sound'
              break
            case 1:
              e.textContent =
                'ru' === a
                  ? '2. Пробуете угадать какой птице принадлежит звук'
                  : '2. Try to guess the bird from the options by its sound'
              break
            case 2:
              e.textContent =
                'ru' === a
                  ? '3. При угадывании с первого раза получаете 5 очков. При каждой ошибке из общего количества очков снимается один балл'
                  : '3. If you guessed right the first time, you will get a maximum of 5 points per question. If you didn’t guess correctly, then with each next attempt, the number of points for this question decreases by 1'
              break
            case 3:
              e.textContent =
                'ru' === a
                  ? '4. При угадывании можно перейти к следующему вопросу'
                  : '4. Once you have guessed the right answer you will be able to move onto the next question'
              break
            case 4:
              e.textContent =
                'ru' === a
                  ? '5. В конце игры можете узнать результаты'
                  : '5. At the end of the game, you will be able to find out the results'
          }
        }),
        (s.textContent = 'ru' === a ? 'НАЧАТЬ' : 'START')
    } else if (document.location.href.includes('game')) {
      let o = document.querySelector('.instruction__text'),
        r = document.querySelector('.game__btn button')
      d.forEach((e, t) => {
        switch (t) {
          case 0:
            e.textContent = 'ru' === a ? 'Разминка' : 'Warm-up'
            break
          case 1:
            e.textContent = 'ru' === a ? 'Воробьиные' : 'Passerines'
            break
          case 2:
            e.textContent = 'ru' === a ? 'Лесные птицы' : 'Forest birds'
            break
          case 3:
            e.textContent = 'ru' === a ? 'Певчие птицы' : 'Song birds'
            break
          case 4:
            e.textContent = 'ru' === a ? 'Хищные птицы' : 'Predator birds'
            break
          case 5:
            e.textContent = 'ru' === a ? 'Морские птицы' : 'Sea birds'
        }
      }),
        (u.textContent = 'ru' === a ? 'Счет:' : 'Score:'),
        (o.innerHTML =
          'ru' === a
            ? 'Послушайте плеер.<br />Выберите птицу из списка.'
            : 'Listen to the player.<br />Select a bird from the list.'),
        (r.textContent = 'ru' === a ? 'Следующий уровень' : 'Next level')
    }
    if (
      (document.location.href.includes('gallery') && p(),
      document.location.href.includes('result'))
    ) {
      let n = document.querySelector('.result__score')
      ;(n.textContent = localStorage.getItem('score')), m()
    }
  }
  'eng' === a
    ? (r.classList.remove('header__btn-lang_active'),
      n.classList.add('header__btn-lang_active'))
    : (n.classList.remove('header__btn-lang_active'),
      r.classList.add('header__btn-lang_active')),
    g()
  let f = document.querySelector('.game__score-num'),
    $ = document.querySelector('.game__current-animal-img'),
    w = document.querySelector('.game__current-animal-title'),
    b = document.querySelectorAll('.game__item'),
    _ = document.querySelector('.instruction'),
    y = document.querySelector('.description-animal'),
    v = document.querySelector('.description-animal__title'),
    k = document.querySelector('.description-animal__kind'),
    C = document.querySelector('.description-animal__img'),
    x = document.querySelector('.description-animal__text'),
    S = document.querySelector('.game__btn'),
    T = [],
    L = document.querySelectorAll('.strip-music'),
    A
  function q() {
  ...
  if (document.querySelector('.audio')) {
    let I = document.querySelectorAll('.audio'),
      O = document.querySelectorAll('.audio__btn-play'),
      P = document.querySelectorAll('.strip-volume'),
      D = document.querySelectorAll('.audio__value'),
      H = document.querySelectorAll('.audio__all-time'),
      F = document.querySelectorAll('.fa-volume-up'),
      G,
      U,
      z = !1
    for (let N = 0; N < I.length; N++) T.push(document.createElement('audio'))
    function B(e) {
      O.forEach((e, t) => {
        R(t)
      }),
        T[e].play(),
        (z = !0),
        (O[e].innerHTML = '<i class="fa fa-pause" aria-hidden="true"></i>')
    }
    function R(e) {
      T[e].pause(),
        (z = !1),
        (O[e].innerHTML = '<i class="fa fa-play" aria-hidden="true"></i>')
    }
    function V() {
      let e = 0
      T.forEach((t, i) => {
        isNaN(t.duration) ||
          ((e = t.currentTime * (100 / t.duration)), (L[i].value = e)),
          t.ended &&
            ((O[i].innerHTML = '<i class="fa fa-play" aria-hidden="true"></i>'),
            (L[i].value = 0))
      })
    }
    T.forEach((e, t) => {
      e.addEventListener('loadedmetadata', (i) => {
        let a = Math.floor(e.duration),
          s = 0
        for (; a >= 60; ) s++, (a -= 60)
        H[t].textContent = `0${s}: ${a > 9 ? a : '0' + a}`
      })
    }),
      clearInterval(U),
      T.forEach((e, t) => {
        if (document.location.href.includes('game')) T[0].src = s[M][A].audio
        else if (document.location.href.includes('gallery')) {
          let i = document.querySelectorAll('.gallery__item-audio')
          e.src = i[t].getAttribute('data-sound')
        }
        e.load()
      }),
      (U = setInterval(V, 1e3)),
      ...
      O.forEach((e, t) => {
        e.addEventListener('click', () => {
          void 0 !== G && G !== t && R(G), (G = t), !1 === z ? B(t) : R(t)
        })
      }),
      P.forEach((e) => {
        e.addEventListener('click', () => {
          D.forEach((e, t) => {
            ;(e.innerHTML = P[t].value), (T[t].volume = P[t].value / 100)
          })
        })
      }),
      L.forEach((e, t) => {
        e.addEventListener('click', () => {
          ;(slider_position = T[t].duration * (e.value / 100)),
            (T[t].currentTime = slider_position)
        })
      })
  }
  if (document.location.href.includes('game')) {
    ...
    function K() {
      b.forEach((e, t) => {
        e.addEventListener('click', (i) => {
          if (
            ((h = e),
            _.classList.remove('instruction_active'),
            y.classList.add('description-animal_active'),
            (v.textContent = s[M][+e.getAttribute('date-item')].name),
            (k.textContent = s[M][+e.getAttribute('date-item')].species),
            R(1),
            (L[1].value = 0),
            (T[1].src = s[M][+e.getAttribute('date-item')].audio),
            (C.src = s[M][+e.getAttribute('date-item')].image),
            (x.textContent = s[M][+e.getAttribute('date-item')].description),
            !j)
          ) {
            if (A === t) {
              R(0)
              let a = new Audio('assets/sounds/correct.mp3')
              a.play(),
                e.classList.add('game__item_right'),
                (w.textContent = s[M][A].name),
                ($.src = s[M][A].image),
                (E += X),
                (f.textContent = E),
                S.classList.add('game__btn_active'),
                (j = !0),
                5 === M &&
                  setTimeout(() => {
              ...
              if (!i.target.classList.contains('game__item_wrong')) {
                let o = new Audio('assets/sounds/incorrect.mp3')
                ;(X = --X), (o.volume = 0.25), o.play()
              }
              e.classList.add('game__item_wrong')
            }
          }
        })
      })
    ...
    W(),
      ...
      S.addEventListener('click', () => {
        ;(M = ++M) < 6 &&
          (d.forEach((e, t) => {
            e.classList.remove('game__pagination-item_active'),
              M === t && e.classList.add('game__pagination-item_active')
          }),
          S.classList.remove('game__btn_active'),
          (j = !1),
          (h = null),
          (X = 5),
          (w.textContent = '******'),
          ($.src = 'assets/images/bird-sihlouette.png'),
          q(),
          (T[0].src = s[M][A].audio),
          _.classList.add('instruction_active'),
          y.classList.remove('description-animal_active'),
          b.forEach((e, t) => {
            ;(e.textContent = s[M][t].name),
              e.classList.remove('game__item_wrong'),
              e.classList.remove('game__item_right')
          }))
      })
  }
  r.addEventListener('click', () => {
    localStorage.setItem('lang', 'ru'),
      ...
      g(),
      o(),
      document.location.href.includes('game') && (W(), h && h.click()),
      document.location.href.includes('gallery') && p(),
      document.location.href.includes('result') && m()
  }),
